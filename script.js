const materias = [
  ...
  { nombre: "Internado de Ginecología y Obstetricia", id: "intgineco", requiere: ["gineco"], semestre: 14 },

  // Semestre 15
  { nombre: "Internado de Pediatría", id: "intpediatria", requiere: ["pediatria"], semestre: 15 },
  { nombre: "Internado de Medicina Interna", id: "intmedint", requiere: ["medint2"], semestre: 15 },
  { nombre: "Internado de Medicina Familiar", id: "intfam", requiere: ["fam"], semestre: 15 },
  { nombre: "Electiva Profesional 3", id: "electivaprof3", requiere: [], semestre: 15 },

  // Semestre 16
  { nombre: "Internado de Emergencias y Urgencias", id: "intemergencias", requiere: ["emergencias"], semestre: 16 },
